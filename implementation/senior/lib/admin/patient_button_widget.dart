...
class PatientButtonsWidget extends StatelessWidget {
  ...
  String phoneNumber = '';
  String email = '';
  var selectedGender; // Move the declaration of 'selectedGender' here
          ...
          TextButton(
            onPressed: () async {
              if (name.isNotEmpty &&
                  ...
                  email.isNotEmpty) { // Replace 'gender' with 'selectedGender'
                try {
                  ...
                  DocumentReference userRef = await FirebaseFirestore.instance.collection('user').add({
                    ...
                    'CPR': cpr,
                    'DOB': birthDay,
                    'Gender': selectedGender, // Change 'gender' to 'selectedGender'
                    'Phone': phoneNumber,
                    'Email': email,
                  });
